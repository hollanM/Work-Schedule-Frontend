...
import emailServices from '../services/emailServices.js' // Generated by Gemini CLI
...
async function publishShifts(){
  ...
  if (currentUser.value && currentUser.value.department_id) {
    const managerName = `${currentUser.value.fName} ${currentUser.value.lName}`;
    try {
      // Generated by Gemini CLI
      await emailServices.notifyDepartment(currentUser.value.department_id, managerName);
      console.log("Department notified successfully");
    } catch (error) {
